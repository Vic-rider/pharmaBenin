...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 11, vars: 0, consts: [[1, "new_auth_wrapper", "__row"], [1, "col-5", "info"], [1, "logo_content", "row"], ["src", "../../../../../assets/images/logo_ hub_csu.jpg", "alt", ""], [1, "title"], [1, "row"], ["routerLink", "/auth/register", 1, "btn", "scu-btn"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
